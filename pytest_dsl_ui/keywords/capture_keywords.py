...
@keyword_manager.register('截图', [
    {'name': '文件名', 'mapping': 'filename', 'description': '截图文件名，如果不指定则自动生成'},
    {'name': '元素定位器', 'mapping': 'element_selector', 'description': '如果指定则只截取该元素'},
    {'name': '全页面', 'mapping': 'full_page', 'description': '是否截取整个页面（包括滚动区域）'},
    {'name': '变量名', 'mapping': 'variable', 'description': '保存截图路径的变量名'},
])
